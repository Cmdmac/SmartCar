...
#include "include/ir_learn.h"
#include "include/ir_encoder.h"
#include "priv_include/ir_learn_err_check.h"
#include "sdkconfig.h"

const char *TAG = "ir learn";

#define RMT_RX_MEM_BLOCK_SIZE       512//CONFIG_RMT_MEM_BLOCK_SYMBOLS
#define RMT_DECODE_MARGIN           200//ONFIG_RMT_DECODE_MARGIN_US
#define RMT_MAX_RANGE_TIME          20000//CONFIG_RMT_SINGLE_RANGE_MAX_US
